...
bool __debug_is_reset() {
  bool reset_power = STATUSbits.TO && STATUSbits.PD && PCON0bits.nPOR;
...
void platform_init(platform_interrupt_callback callback) {
  ...
  pic16f18876_setup_spi_playstation();
  pic16f18876_setup_timing();
  pic16f18876_setup_uart_serial();
  pic16f18876_setup_wired_controller();

...
#define PIC_SPI_PPS_SCK_REGISTER SPI1SCKPPS   // Table 17-1 in PIC16F18876 data sheet
#define PIC_SPI_PPS_MOSI_REGISTER SPI1SDIPPS  // Table 17-1 in PIC16F18876 data sheet
#define PIC_SPI_PPS_ATT_REGISTER SPI1SSPPS    // Table 17-1 in PIC16F18876 data sheet
#define PIC_SPI_PPS_MISO_CHANNEL 0b011111     // Table 17-2 in PIC16F18876 data sheet
 ...
 */
void __interrupt(irq(IRQ_SPI1RX), base(PIC_IVT_BASE)) pic16f18876_interrupt_spi() {
...
void pic16f18876_setup_spi_playstation() {
  SSP1IF = 0;
  ...
  SSP1STATbits.CKE = 0; // Output Data is sampled on the rising edge of the clock
